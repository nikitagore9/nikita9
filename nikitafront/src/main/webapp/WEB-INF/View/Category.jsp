...
<tr>
      ...
      <td><a href="<c:url value = '/admin/Category/update/${cat.c_id}'/> " class="btn btn-info btn-sm">
          <span class="glyphicon glyphicon-pencil"></span> Edit</a></td>
      
      
      <td><a href="<c:url value = '/admin/Category/delete/${cat.c_id}'/> " class="btn btn-info btn-sm">
